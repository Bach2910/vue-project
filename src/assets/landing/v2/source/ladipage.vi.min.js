...
LadiPageScriptV2.prototype.loadDataset = function(t, e, i, a, n, o, r, d) {
    ...
    if (!isEmptyLadiPage(m)) {
        ...
        if (!isEmptyLadiPage(g)) {
            ...
            if (!isEmptyLadiPage(y)) {
                ...
                f.toLowerCase().startsWith('url("') && f.toLowerCase().endsWith('")') && (f = (f = f.substr(5)).substr(0, f.length - 2), isEmptyLadiPage(f) || (_ = f))
            }
        }
                ...
                P = function() {
                    try {
                        if (c.runtime.isLoadYouTubeIframeAPI && c.runtime.isYouTubeIframeAPIReady || !isObjectLadiPage(window.YT) || !isFunctionLadiPage(window.YT.Player) || (c.runtime.isLoadYouTubeIframeAPI = !0, c.runtime.isYouTubeIframeAPIReady = !0), c.runtime.isLoadYouTubeIframeAPI || (c.runtime.isLoadYouTubeIframeAPI = !0, window.onYouTubeIframeAPIReady = function() {
                                for (c.runtime.isYouTubeIframeAPIReady = !0; c.runtime.list_youtube_ready_exec.length > 0;) c.runtime.list_youtube_ready_exec.shift()()
    ...
    try {
        ...
        for (var e = document.querySelectorAll("#" + t.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), i = 0; i < e.length; i++) "none" != getComputedStyle(e[i]).display && (t.runtime.tmp.is_resize_all = !0, window.ladi(e[i].id).show(!0, {
    ...
    if (!isEmptyLadiPage(t) && !isEmptyLadiPage(e) && isObjectLadiPage(window.ladi_conversion_api) && isObjectLadiPage(window.ladi_conversion_api[t]) && (window.ladi_conversion_api[t][e] = i), isObjectLadiPage(window.ladi_conversion_api) && isObjectLadiPage(window.ladi_conversion_api.facebook) && isArrayLadiPage(window.ladi_conversion_api.facebook.pixels) && isArrayLadiPage(window.ladi_conversion_api.facebook.events) && isFunctionLadiPage(window.fbq)) {
    ...
    isFunctionLadiPage(this.runtime.send_request_response[e]) && this.runtime.send_request_response[e](e, i, r) || (isFunctionLadiPage(r) && (s.onreadystatechange = function() {
        var t = null;
        try {
            t = this.responseText
        } catch (t) {}
        r(t, this.status, this, e)
    }), s.open(t, e, a), isObjectLadiPage(n) && Object.keys(n).forEach((function(t) {
    ...
    if (e instanceof LadiPageScriptV2 || (e = LadiPageScript), e.runtime.isRun) {
        if (!isEmptyLadiPage(e.runtime.eventData) && !e.runtime.tmp.is_run_show_popup) {
            ...
            if (Object.keys(e.runtime.eventData).forEach((function(t) {
                    var a, n = e.runtime.eventData[t],
                        r = null,
                        d = null,
                        s = null,
                        l = Object.keys(e.runtime.list_scroll_func);
                    a = "gallery" == n.type ? document.querySelectorAll("#" + t) : [s = document.getElementById(t)];
                    for (var c = 0; c < a.length; c++)
                        if (s = a[c], !isEmptyLadiPage(s)) {
                            var u = "gallery" == n.type ? s.getAttribute("data-runtime-id") : s.getAttribute("id");
                            if (-1 != l.indexOf(u)) {
                                var p = !1;
                                "section" == n.type ? (r = s.offsetTop, (window.scrollY >= r && window.scrollY <= r + s.offsetHeight || window.scrollY + e.getHeightDevice() >= r && window.scrollY + e.getHeightDevice() <= r + s.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice() >= r) && (p = !0)) : (r = e.getElementBoundingClientRect(s).y + window.scrollY, (window.scrollY >= r && window.scrollY <= r + s.offsetHeight || window.scrollY + e.getHeightDevice(!0) >= r && window.scrollY + e.getHeightDevice(!0) <= r + s.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= r) && (p = !0)), p && (d = e.runtime.list_scroll_func[u], delete e.runtime.list_scroll_func[u], d())
                            }
                        }
                    var m = n[e.runtime.device + ".style.animation-name"];
                    if (!isEmptyLadiPage(m) && (s = document.getElementById(t), !isEmptyLadiPage(s) && !s.classList.contains("ladi-animation"))) {
                        var g = parseFloatLadiPage(n[e.runtime.device + ".style.animation-delay"]) || 0;
                        r = e.getElementBoundingClientRect(s).y + window.scrollY;
                        var _ = window.scrollY >= r && window.scrollY <= r + s.offsetHeight || window.scrollY + e.getHeightDevice(!0) >= r && window.scrollY + e.getHeightDevice(!0) <= r + s.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= r;
                        e.runtime.tmp.isFirstScroll && g > 0 && s.classList.add("ladi-animation-hidden"), _ && (s.classList.add("ladi-animation"), e.runTimeout((function() {
                    ...
                    if (isEmptyLadiPage(i) || -1 != o.indexOf(t)) {
                        var y = null,
                            f = null,
                            v = null;
                        if (n[e.runtime.device + ".option.sticky"] && (y = n[e.runtime.device + ".option.sticky_position"], f = parseFloatLadiPage(n[e.runtime.device + ".option.sticky_position_top"]), v = parseFloatLadiPage(n[e.runtime.device + ".option.sticky_position_bottom"])), !e.runtime.has_popupx && !isEmptyLadiPage(y)) {
                            ...
                            if (!isEmptyLadiPage(P) && P.clientWidth > 0 && P.clientHeight > 0 && -1 != ["default", "top", "bottom"].indexOf(y)) {
                                ...
                                else if ("section" == n.type && (e.runtime.is_mobile_only ? P.style.setProperty("width", T.clientWidth + "px") : e.runtime.isDesktop && P.style.setProperty("width", "100%"), S > 0 && (T.setAttribute("data-padding-top-id", t), T.style.setProperty("padding-top", S + "px")), O > 0 && (T.setAttribute("data-padding-bottom-id", t), T.style.setProperty("padding-bottom", O + "px")), C > 0 && T.setAttribute("data-scroll-padding-top", C), N > 0 && T.setAttribute("data-scroll-padding-bottom", N)), P.style.setProperty("top", b), P.style.setProperty("left", A), P.style.setProperty("position", "fixed"), P.style.setProperty("z-index", "90000050"), !P.hasAttribute("data-sticky")) {
                    ...
                    if ("section" == n.type) {
                        ...
                        s = document.getElementById(t), isEmptyLadiPage(s) || (r = s.offsetTop, (window.scrollY >= r && window.scrollY <= r + s.offsetHeight || window.scrollY + e.getHeightDevice() >= r && window.scrollY + e.getHeightDevice() <= r + s.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice() >= r) && (e.runtime.scroll_to_section[t] = !0, e.runEventTracking(t, {
                            is_form: !1
                        })))
                    }
                })), e.runtime.isClient) {
    ...
    })), d && isFunctionLadiPage(i) && i(), a && l(), !n && s && o.runtime.tmp.runActionPopupX({
        id: t,
        dimension: {
            display: "none"
        },
    ...
    if (!isEmptyLadiPage(e)) {
        ...
        if (!n || !isEmptyLadiPage(r) && isObjectLadiPage(o.runtime.eventData) && !isEmptyLadiPage(o.runtime.eventData[e])) {
            ...
            var d = function(t) {
                    ...
                    var s = 0,
                        l = "";
                    n || LadiPagePlugin.getPlugin("popup").showStyleShowPopupBuilder(e), isEmptyLadiPage(a) ? l += n ? "#" + o.runtime.backdrop_popup_id + " { display: none !important;}" : "#" + o.runtime.backdrop_popup_id + " { display: block !important;}" : (l += "#" + o.runtime.backdrop_popup_id + " { display: block !important; " + a + "}", r.setAttribute("data-popup-backdrop", !0)), i == o.const.POSITION_TYPE.default && "true" != r.getAttribute("data-dropbox") && (function() {
                    ...
                    t ? L() : (f = o.runTimeout((function() {
                        "none" == getComputedStyle(r).display ? (s -= 100, L()) : d(!0), r.removeAttribute("data-timeout-id-2")
                    }), 100), r.setAttribute("data-timeout-id-2", f)), r.removeAttribute("data-timeout-id-3")
                },
                s = 0;
    ...
    if (this.runtime.isClient) {
        ...
        var f = function(t) {
                ...
                isEmptyLadiPage(r) || (-1 != ["AddPaymentInfo", "AddToCart", "AddToWishlist", "CompleteRegistration", "Contact", "CustomizeProduct", "Donate", "FindLocation", "InitiateCheckout", "Lead", "PageView", "Purchase", "Schedule", "Search", "StartTrial", "SubmitApplication", "Subscribe", "ViewContent"].indexOf(r) && (n = "track"), isEmptyLadiPage(c) || isEmptyLadiPage(u) || ((e = {}).value = c, e.currency = u), !t && isObjectLadiPage(window.ladi_conversion_api) && isObjectLadiPage(window.ladi_conversion_api.facebook) && isArrayLadiPage(window.ladi_conversion_api.facebook.pixels) && (a = l()), d.push({
                    ...
                    isObjectLadiPage(i) && (isObjectLadiPage(a) || (a = {}), a.email = i.email, a.phone = i.phone), s = [{
                        key: e.fbq_track_name,
                        name: e.conversion_name,
                        custom_data: e.fbq_data,
                        data: a
                    }], o.runConversionApi("facebook", "events", s), t && (o.runtime.tmp.runActionPopupX({
                ...
                }))), _ && (n = "trackCustom", e = null, a = null, d = [], !t && isObjectLadiPage(window.ladi_conversion_api) && isObjectLadiPage(window.ladi_conversion_api.facebook) && isArrayLadiPage(window.ladi_conversion_api.facebook.pixels) && (a = l()), d.push({
                    fbq_track_name: n,
            ...
            v = function(t) {
                ...
                if (!isEmptyLadiPage(r)) {
                    ...
                    l = {
                        event_category: g,
                        event_label: window.location.host + window.location.pathname
                    }, isEmptyLadiPage(c) || isEmptyLadiPage(u) || (l.value = c, l.currency = u), t ? o.runtime.tmp.runActionPopupX({
                        conversion_name: r,
                        gtag_data: l,
                        action: {
                            type: "run_tracking_gtag"
            ...
            P = function(t) {
                ...
                if (isObjectLadiPage(i) && (e = {
                    ...
                    }).value = c, a.currency = u), t ? o.runtime.tmp.runActionPopupX({
                        conversion_name: r,
                        ttq_data: a,
                        action: {
                ...
                _ && (o.runLadiPageCommand((function(e) {
                    if (e.tiktokViewContent && e.clickButton) return t ? o.runtime.tmp.runActionPopupX({
        ...
        if (o.runtime.is_popupx) return f(!0), v(!0), P(!0), void o.runtime.tmp.runActionPopupX({
            script: l,
            action: {
    ...
    if (t = this.convertDataReplaceStr(t, !1, null, !1, e), this.runtime.has_popupx) this.runtime.tmp.popupx_show_message_callback = i, this.runtime.tmp.runActionPopupX({
        message: t,
        action: {
            type: "show_message"
        }
    ...
    return a.initEvent(e, !0, !0), isObjectLadiPage(i) && Object.keys(i).forEach((function(t) {
        a[t] = i[t]
    })), !t.dispatchEvent(a)
    ...
    var i = Math.floor(t / 1e3),
        ...
        d = Math.floor(n / 60),
        s = n % 60;
    o = (o = o < 0 ? 0 : o) < 10 ? "0" + o : o, r = (r = r < 0 ? 0 : r) < 10 ? "0" + r : r, d = (d = d < 0 ? 0 : d) < 10 ? "0" + d : d, s = (s = s < 0 ? 0 : s) < 10 ? "0" + s : s;
    var l = {};
    ...
    var e = this;
    if (isObjectLadiPage(t) && Object.keys(t).forEach((function(i) {
    ...
    if (e.runtime.isLoadHtmlGlobal) {
        ...
        var _ = Object.keys(e.runtime.eventData),
            ...
            C = function(t, i, a) {
                if ("FormSubmit" == t && isEmptyLadiPage(f)) isFunctionLadiPage(a) && a();
                    ...
                    Object.keys(i).forEach((function(t) {
                        ...
                        C(t, i, a)
                    }), 100) : ("FormSubmit" == t && (isEmptyLadiPage(L) ? P++ : (A == w && P++, S++), window.ladi("LADI_CAMP_FORM_SUBMIT").set_cookie(S, 3650), window.ladi("LADI_FORM_SUBMIT").set_cookie(P, 3650), e.runtime.is_popupx && e.runtime.tmp.runActionPopupX({
                        action: {
                            type: "set_submit_form"
                        }
                    })), "PageView" == t && e.runtime.has_popupx && (v++, window.ladi("LADI_PAGE_VIEW").set_cookie(v, 3650)), "FormSubmit" != t && "PageView" != t || isEmptyLadiPage(e.runtime.tmp.cookie_ladi_data) || !e.runtime.is_popupx && isEmptyLadiPage(L) || (c.ladi_data = e.runtime.tmp.cookie_ladi_data), e.sendRequest("POST", e.const.API_ANALYTICS_EVENT, JSON.stringify(c), !0, {
                    ...
                    if (isEmptyLadiPage(i) || "POPUP_BLOG" != i.id) isFunctionLadiPage(n) && n();
                        ...
                        var l = function() {
                            ...
                            if (Object.keys(o.product).forEach((function(t) {
                                ...
                                e.showParentVisibility(r[0], (function() {
                                    for (s = 0; s < r.length; s++) r[s].querySelectorAll(".ladi-headline, .ladi-paragraph").length > 0 && !r[s].hasAttribute("data-height") && r[s].setAttribute("data-height", r[s].clientHeight)
                                }));
                                var m = function(t) {
                                ...
                                for (s = 0; s < r.length; s++) e.runtime.tmp.runLadiSaleProductKey(r[s].id, !1, !1, d, o, !0, null, !0), t = r[s], a = e.runtime.eventData[t.id], isFunctionLadiPage(e.runtime.tmp.runOptionAction) && isObjectLadiPage(a) && e.runtime.tmp.runOptionAction(t, t.id, a.type, a, o);
                                for (s = 0; s < r.length; s++)
                                    ...
                                    a.type == e.const.DATA_ACTION_TYPE.set_value && t.addEventListener("click", (function(i) {
                                        ...
                                        if (d(t, i) && l(a)) {
                                            ...
                                            isEmptyLadiPage(o) || (n = o.value(null, null, {
                                                only_text: !0
                                            })), n = isEmptyLadiPage(n) ? a.str : n, isEmptyLadiPage(n) || e.copyTextClipboard(n, _)
                                        }
                                    }));
                                    var u = null;
                ...
                if ("gallery" == n && (a || (i = document.getElementById(t)), !isEmptyLadiPage(i))) {
                    ...
                    if (o > 0) {
                        for (var s = 0; s < o; s++) {
                            ...
                            isEmptyLadiPage(l) || (d && Y(i, l, d), l.classList.contains("play-video") && l.addEventListener("click", r))
                        }
            ...
            j = function(t, i) {
                ...
                (c = "true" == c.toLowerCase()) ? d-- : d++, i.setAttribute("data-current", d), i.setAttribute("data-next-time", Date.now() + 1e3 * r), M(i, !1, s, l)
            },
            H = function() {
                            ...
                            if ("true" == o.getAttribute("data-scrolled") && "true" != o.getAttribute("data-stop")) {
                                ...
                                if (r && !isEmptyLadiPage(d) && (s = d), s > 0) {
                                    var l = o.getAttribute("data-next-time"),
                                        c = Date.now();
                                    isEmptyLadiPage(l) && (l = c + 1e3 * (s - 1), o.setAttribute("data-next-time", l)), c >= l && (M(o, !0), o.setAttribute("data-next-time", c + 1e3 * s))
                                }
                            }
                        }
                }))
            ...
            G = function(t, i) {
                ...
                if ("gallery" == a.type) {
                    ...
                    i.hasAttribute("data-scrolled") || (i.setAttribute("data-scrolled", !1), e.runtime.list_scroll_func[n] = function() {
                    ...
                    i.getElementsByClassName("ladi-gallery-view-arrow-left")[0].addEventListener("click", (function(t) {
                        t.stopPropagation(), i.setAttribute("data-is-next", !1), i.setAttribute("data-next-time", Date.now() + 1e3 * d), M(i, !1)
                        ...
                        t.stopPropagation(), i.setAttribute("data-is-next", !0), i.setAttribute("data-next-time", Date.now() + 1e3 * d), M(i, !1)
            ...
            z = function(t) {
                var e = null;
                return isEmptyLadiPage(t) || (e = t.classList.contains("no-value") ? null : t.getAttribute("data-value")), isEmptyLadiPage(e) ? "" : e
            },
            K = function(t, e) {
            ...
            $ = function(t, i) {
                ...
                K(d, r), isFunctionLadiPage(i) && i(d)
            },
            Z = function(i, a, n, o) {
                if ("form" == a) {
                                    ...
                                    if (!isEmptyLadiPage(c) && !isEmptyLadiPage(u)) {
                                        ...
                                        if (!(isEmptyLadiPage(p) || isEmptyLadiPage(p.store_info) || isEmptyLadiPage(p.product))) {
                                            ...
                                            e.showParentVisibility(s, (function() {
                                                ...
                                                for (o = 0; o < c.length; o++) n[c[o].getAttribute("data-store-id") + "_" + c[o].getAttribute("data-product-id") + "_" + c[o].getAttribute("data-product-option-id")] = J(c[o]);
                                                s.innerHTML = m;
                                                ...
                                                for (f = 0; f < v.length; f++) {
                                                    ...
                                                    u = n[v[f].getAttribute("data-store-id") + "_" + v[f].getAttribute("data-product-id") + "_" + v[f].getAttribute("data-product-option-id")], isNullLadiPage(u) && (p = P[1], isEmptyLadiPage(p) || (u = z(p))), K(v[f], u)
                                                }
            ...
            tt = function(i, a, n, o, r, d, s, l) {
                ...
                if (!isEmptyLadiPage(c)) {
                    ...
                    if ("gallery" == m) {
                        ...
                        if (L = document.getElementById(i), isEmptyLadiPage(L)) return;
                        if (n && "true" == L.getAttribute("data-loaded")) return void Q(L, f, c);
                ...
                if ((isEmptyLadiPage(u) || "print" == u.getAttribute("media")) && (c = {
                    ...
                    if ("popup" == n.type) {
                        ...
                        var m = n[e.runtime.device + ".option.popup_position"],
                            g = !1;
                        if (isObjectLadiPage(a) && !isNullLadiPage(a.formThankyouPopupXInline) && (g = a.formThankyouPopupXInline), g) return m == e.const.POSITION_TYPE.default ? et({
                        ...
                        s = (d = nt(t)).isCurrentPopup, l = d.isCurrentSection, ["width", "height", "position", "margin", "top", "left", "bottom", "right", "z-index"].forEach((function(t) {
                            r[t] = p[t]
                        })), it(r.width), c.width = r.width;
                        ...
                        }), window.ladi(t).show(!0), at(t, i, s, l), !0
                    }
                    if ("section" == n.type) {
                        if (s = (d = nt(t)).isCurrentPopup, l = d.isCurrentSection, n[e.runtime.device + ".option.sticky"]) {
                            r = {
                                height: p.height
                            };
                            var y = o.getElementsByClassName("ladi-container")[0],
                                f = getComputedStyle(y);
                            it(f.width), c.width = f.width, c.is_sticky_bar = !0, et({
                                id: t,
                                data_scale: c,
                                dimension: r,
                                element: n,
                            ...
                            }), window.ladi(t).show(!0), at(t, i, s, l)
                        }
                        return !0
                    }
                }
            ...
            st = function() {
                ...
                e.changeTotalPriceCart(), e.runtime.tmp.generateLadiSaleProduct(!0), e.runtime.shopping && e.createCartData(), e.loadDataset(null, null, null, null, null, !0, t), _.forEach((function(i) {
                        ...
                        isEmptyLadiPage(n) ? (function(t, i, a, n, o, r) {
                        ...
                        }(i, a.type, a["option.input_type"]), V(i, null, !1, a.type), e.startAutoScroll(i, a.type, a[e.const.DESKTOP + ".option.auto_scroll"], a[e.const.MOBILE + ".option.auto_scroll"]), Z(i, a.type, !0, !1), function(t, i) {
                            if ("form" == i) {
                                var a = document.getElementById(t);
                                if (!isEmptyLadiPage(a)) {
                            ...
                            if ("survey" == i) {
                                ...
                                if (!isEmptyLadiPage(o)) {
                                    ...
                                    for (var r = o.getElementsByClassName("ladi-survey-select-item")[0], d = o.getElementsByClassName("ladi-survey-radio-item"), s = o.getElementsByClassName("ladi-survey-checkbox-item"), l = o.getElementsByClassName("ladi-survey-option"), c = o.querySelector(".ladi-survey-button-next button"), u = [], p = n.mapping_form_name, m = n.mapping_form_id, g = n.input_name, _ = e.findAncestor(o, ["ladi-form", "ladi-element"]), y = e.runtime.eventData[t]["option.data_event"], f = function() {
                                            ...
                                            m.forEach((function(t) {
                                                ...
                                                if (!isEmptyLadiPage(o)) {
                                                    ...
                                                    for (A = 0; A < s.length; A++) {
                                                        s[A].getAttribute("name") == n && (l = e.findAncestor(s[A], "ladi-element"), d.push(l.id));
                                                        var p = parseFloatLadiPage(s[A].getAttribute("tabindex")) || 0;
                                                        p > c && (c = p)
                                                    }
                                                    ...
                                                    for (A = 0; A < d.length; A++) window.ladi(d[A]).value(i)
                                                }
                                            }))
                                        }, v = function() {
                                            for (var t = !1, e = 0; e < l.length; e++)
                                                if (l[e].classList.contains("selected")) {
                                                    t = !0;
                                                    break
                                                }
                                            return t
                                        }, P = function() {
                                            if (!(!isEmptyLadiPage(r) || d.length > 0 || s.length > 0)) {
                                                for (var t = [], i = 0; i < l.length; i++) l[i].classList.contains("selected") && t.push(l[i].getAttribute("data-value"));
                                                for (var n = null; 0 != (n = _.querySelectorAll('.ladi-form-item-survey[data-name="' + g + '"]')).length;) n[0].parentElement.removeChild(n[0]);
                                                var c = document.createElement("div");
                                                c.className = "ladi-element ladi-hidden ladi-form-item-survey", c.id = e.randomString(10), c.setAttribute("data-name", g);
                                            ...
                                            e.tapEventListener(t, (function(e) {
                                                ...
                                                isEmptyLadiPage(_) ? (b(), isEmptyLadiPage(c) && h()) : P()
                                            }))
                                        }, E = function(t) {
                                            ...
                                            isEmptyLadiPage(c) || (v() ? c.parentElement.classList.remove("no-select") : c.parentElement.classList.add("no-select"))
                                        }, A = 0; A < l.length; A++) u.push(l[A].getAttribute("data-value")), L(l[A]);
                                    for (isEmptyLadiPage(r) || r.addEventListener("change", (function(t) {
                                            t.target.setAttribute("data-selected", t.target.value)
                                        })), A = 0; A < d.length; A++) u.push(d[A].getElementsByTagName("input")[0].value), E(d[A]);
                                    for (A = 0; A < s.length; A++) u.push(s[A].getElementsByTagName("input")[0].value), E(s[A]);
                                    if (isEmptyLadiPage(_)) {
                                        if (!isArrayLadiPage(y)) {
                                            var w = e.copy(n);
                                            if (y = [], isObjectLadiPage(w) && !isEmptyLadiPage(w.value)) {
                                                if (w.type != e.const.DATA_ACTION_TYPE.section && w.type != e.const.DATA_ACTION_TYPE.popup || y.push({
                                                        action_type: e.const.ACTION_TYPE.complete,
                                                        type: w.type,
                                                        action: w.value
                                                    }), w.type == e.const.DATA_ACTION_TYPE.section && w.is_hide_parent || w.type == e.const.DATA_ACTION_TYPE.popup) {
                                                    var T = e.findAncestor(o, "ladi-popup"),
                                                        S = e.findAncestor(o, "ladi-section"),
                                                        O = null;
                                                    isEmptyLadiPage(T) ? isEmptyLadiPage(S) || (O = S.id) : O = (T = e.findAncestor(T, "ladi-element")).id, isEmptyLadiPage(O) || y.push({
                                                        action_type: e.const.ACTION_TYPE.complete,
                                                ...
                                                w.type == e.const.DATA_ACTION_TYPE.change_index && y.push({
                                                    action_type: e.const.ACTION_TYPE.complete,
                                                    type: w.type,
                                                    action: w.value,
                                        ...
                                        isEmptyLadiPage(c) || c.addEventListener("click", (function(t) {
                                            t.stopPropagation(), h()
                                        })), b(), e.runtime.list_loaded_func.push(f)
                                    } else P()
                                }
                            }
                    ...
                    function() {
                        var i, a = document.getElementsByClassName("ladi-form"),
                            ...
                            M = function(t, i) {
                                ...
                                if (p.only(e.runtime.list_set_value_name_country).length == e.runtime.list_set_value_name_country.length)
                                    for (var g = 0; g < p.length; g++) {
                                        var _ = e.runtime.list_set_value_name_country.indexOf(p[g]); - 1 != _ && (p[g] = F[_])
                                    }
                            ...
                            Y = function(t, i, a, d, s) {
                                ...
                                isObjectLadiPage(S) && (l = e.copy(S)), isEmptyLadiPage(b) || (l.captcha_token = b, l.captcha_type = w), i.isFormOtp && (i.isSetOtpId && function() {
                                    var t = "_otp_id_" + f,
                                            ...
                                            if (y = [], isObjectLadiPage(f) && (f.type = f.event_type, f.value = f.event_value, f.is_hide_parent = f.event_is_hide_parent, f.change_index_type = f.event_change_index_type, f.change_index_number = f.event_change_index_number, !isEmptyLadiPage(f.value))) {
                                                if (f.type != e.const.DATA_ACTION_TYPE.section && f.type != e.const.DATA_ACTION_TYPE.popup || y.push({
                                                    ...
                                                    var v = e.findAncestor(t, "ladi-popup"),
                                                        ...
                                                        h = null;
                                                    isEmptyLadiPage(v) ? isEmptyLadiPage(P) || (h = P.id) : h = (v = e.findAncestor(v, "ladi-element")).id, isEmptyLadiPage(h) || y.push({
                                                        action_type: e.const.ACTION_TYPE.complete,
                                                        type: e.const.DATA_ACTION_TYPE.hidden_show,
                                                        hidden_ids: [h],
                                                        show_ids: []
                                        ...
                                        if (s) {
                                            ...
                                            if (a.captcha && !isEmptyLadiPage(k) && k["option.form_captcha"] && isObjectLadiPage(e.runtime.tmp.google_captcha)) {
                                                if (window.grecaptcha)
                                                    if (e.runtime.tmp.google_captcha.enterprise && window.grecaptcha.enterprise) window.grecaptcha.enterprise.ready((function() {
                                                        try {
                                                    ...
                                                    D = i.getElementsByClassName("ladi-google-recaptcha-checkbox")[0], R = i.getAttribute("data-button-submit-other"), isEmptyLadiPage(R) || (D = document.querySelector("#" + R + " .ladi-google-recaptcha-checkbox")), F = D.getAttribute("data-widget-id"), q = window.grecaptcha.getResponse(F), U(i, {
                                                        captcha_token: q
                                                    }, s, l, g, A)
                                            ...
                                            Y(0, A, s, l, (function(t) {
                                                ...
                                                !isEmptyLadiPage(e.runtime.tmp.capture_form_data_last[l + "_" + g]) && equalsLadiPage(e.runtime.tmp.capture_form_data_last[l + "_" + g], a) || (e.runtime.tmp.capture_form_data_last[l + "_" + g] = a, e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {
                                                    "Content-Type": "application/json"
                                                }))
                                            }))
                                            ...
                                            if (a.captcha && !isEmptyLadiPage(k) && k["option.form_captcha"] && isObjectLadiPage(e.runtime.tmp.google_captcha))
                                                if (window.grecaptcha)
                                                    if (G(), e.runtime.tmp.google_captcha.enterprise && window.grecaptcha.enterprise) window.grecaptcha.enterprise.ready((function() {
                                                        try {
                                                            window.grecaptcha.enterprise.execute(e.runtime.tmp.google_captcha.api_key, {
                                                                action: "submit"
                                                            }).then((function(t) {
                                                ...
                                                D = i.getElementsByClassName("ladi-google-recaptcha-checkbox")[0], R = i.getAttribute("data-button-submit-other"), isEmptyLadiPage(R) || (D = document.querySelector("#" + R + " .ladi-google-recaptcha-checkbox")), F = D.getAttribute("data-widget-id"), q = window.grecaptcha.getResponse(F), W(), U(i, {
                                                    captcha_token: q
                                                }, s, l, g, A)
                                            } catch (t) {
                                                H(), W()
                                                ...
                                                var X = k["option.form_send_ladipage"],
                                                    ...
                                                    tt = function() {
                                                        ...
                                                        if (!Q || isEmptyLadiPage(h)) {
                                                            if (K == e.const.FORM_THANKYOU_TYPE.default && (isEmptyLadiPage(J) || e.showMessage(J, p)), K == e.const.FORM_THANKYOU_TYPE.popup && (Z && e.setDataReplaceElement(!1, !1, p, J), window.ladi(J).show(!1, {
                                                ...
                                                if (isEmptyLadiPage(_) && isEmptyLadiPage(k["option.sync_ladisales_form_account_id"]) && isEmptyLadiPage(k["option.sync_ladiflow_form_account_id"]) && isEmptyLadiPage(k["option.sync_ladishare_form_account_id"]) && isEmptyLadiPage(k["option.sync_ladichat_form_account_id"])) j(0, A, O, l);
                                                    ...
                                                    var at = 0,
                                                        ...
                                                        pt = function(t, a, n, o) {
                                                            if (n.readyState == XMLHttpRequest.DONE) {
                                                                ...
                                                                s = isObjectLadiPage(s) ? s : {}, o == e.const.API_FORM_DATA ? 200 == s.code ? at++ : (1 != s.code || isEmptyLadiPage(s.message) || (ot = s.message), nt++, lt = !1) : 200 == a || 201 == a || e.getElementAHref(o).host == e.const.DOMAIN_GOOGLE_DOCS ? at++ : nt++, at + nt == rt.length && (lt && !dt && at >= 1 ? (dt = !0, isFunctionLadiPage(A.callbackOtp) && A.callbackOtp(!0), isObjectLadiPage(A) && isFunctionLadiPage(A.callbackThankyou) ? (W(), A.callbackThankyou(A, (function() {
                                                                    ut((function() {
                                                                    ...
                                                                    e.runEventTracking(i.id, {
                                                                        is_form: !0
                                                                    }, r), window.ladi("_capture_" + i.id).delete_cookie(), isObjectLadiPage(A) && isFunctionLadiPage(A.callbackOtpDone) && A.callbackOtpDone(), ut((function() {
                                                                        e.runTimeout((function() {
                                                    ...
                                                    X && Y(0, A, s, l, mt), isArrayLadiPage(z) && z.forEach((function(t) {
                                                        if (!isEmptyLadiPage(t.api_url) && isArrayLadiPage(t.custom_fields)) {
                                                            ...
                                                            i || (a.link = window.location.href, e.runtime.has_popupx && (a.origin_link = e.runtime.tmp.popupx_origin_url), Object.keys(LadiFormApi).forEach((function(t) {
                                                                a[t] = LadiFormApi[t]
                                                            })), x.forEach((function(t) {
                                                                var e = I[t];
                                                            ...
                                                            m == e.const.CONTENT_TYPE.form_urlencoded && (s["Content-Type"] = "application/x-www-form-urlencoded", p = Object.keys(a).reduce((function(t, e) {
                                ...
                                if (!isEmptyLadiPage(o)) {
                                    ...
                                    if (!(isEmptyLadiPage(r) || (a = i ? a : e.runtime.eventData[r.id], isEmptyLadiPage(a) || !a["option.is_buy_now"] && !a["option.is_add_to_cart"] || isEmptyLadiPage(a["option.product_type"]) || isEmptyLadiPage(a["option.product_id"])))) {
                                        var d = function() {
                                            ...
                                            if (isEmptyLadiPage(o) || isEmptyLadiPage(o.store_info) || isEmptyLadiPage(o.product)) isEmptyLadiPage(e.runtime.tmp.timeout_product_info[a["option.product_type"]][a["option.product_id"]]) && e.showMessage(e.const.LANG.ADD_TO_CART_NO_PRODUCT, {
                                                ...
                                                if (-1 != s) {
                                                    ...
                                                    if (f = isEmptyLadiPage(f) && isObjectLadiPage(o.product.image) ? o.product.image.src : f, isEmptyLadiPage(f) || !isStringLadiPage(f) || f.startsWith("http://") || f.startsWith("https://") || f.startsWith("//") || (f = "https://" + e.const.STATIC_W_DOMAIN + "/" + f), 0 == o.product.select_many_service && isArrayLadiPage(e.runtime.tmp.cart) && -1 != e.runtime.tmp.cart.findIndex((function(t) {
                                                        ...
                                                        if (isEmptyLadiPage(L) || isEmptyLadiPage(L.value)) e.showMessage(e.const.LANG.ADD_TO_CART_QUANTITY_REQUIRED);
                                                            ...
                                                            if (!isEmptyLadiPage(w) && e.runtime.tmp.cart[v].quantity + E > w && (E = w - e.runtime.tmp.cart[v].quantity) <= 0 && (T = !0, b = w), 1 == o.product.variants[s].inventory_checked) {
                                                                if (A > _) return void e.showMessage(e.const.LANG.ADD_TO_CART_NO_QUANTITY, {
                                                            ...
                                                            if (T || E <= 0 && _ > 0) e.showMessage(e.const.LANG.ADD_TO_CART_MAX_QUANTITY, {
                                                                max: b,
                                                                name: e.getMessageNameProduct(o.product.variants[s])
                                                            }, (function() {
                                                                var i = t.target;
                                                                ...
                                                                else if (O) e.showMessage(e.const.LANG.ADD_TO_CART_PRODUCT_AFTER_END_DATE, {
                                                                    name: e.getMessageNameProduct(o.product.variants[s])
                                                                });
                                                                else {
                                                                    var C = function() {
                                                            ...
                                                            } else _ <= 0 && e.showMessage(e.const.LANG.ADD_TO_CART_NO_QUANTITY, {
                                                                name: e.getMessageNameProduct(o.product.variants[s], !0)
                                                            })
                                                        }
                                                    }
                                    ...
                                    if (!isEmptyLadiPage(a)) {
                                        ...
                                        if (!isEmptyLadiPage(n)) {
                                            ...
                                            if (isObjectLadiPage(n["option.form_setting"]) && n["option.form_setting"].is_multiple) {
                                                if (!n["option.form_setting"].is_multiple_otp) return void G(a, n, !0, t.target.getAttribute("name"), {
                                                    isRunTracking: !0
                                                });
                        ...
                        vt(e.copy(D).except(e.runtime.list_set_value_name_country)), e.runtime.tmp.listAfterLocation.push((function() {
                            var t = "",
                                i = "",
                                n = "",
                                o = "",
                                ...
                                l = function(t) {
                                    ...
                                    if (!isEmptyLadiPage(o)) {
                                        ...
                                        isEmptyLadiPage(l) || "SELECT" == l.tagName && (l.setAttribute("data-selected", ""), l.innerHTML = l.querySelector("option").outerHTML), e.reloadFeeShipping({
                                            target: l
                                        })
                                    }
                                },
                            ...
                            if ("countdown" == i.type)
                                for (var a = document.querySelectorAll("#" + t), n = 0; n < a.length; n++) {
                                    ...
                                    if (g < 0) {
                                        ...
                                        "true" != o.getAttribute("data-end") && (o.setAttribute("data-end", !0), k(o, i["option.data_event"]), e.runEventTracking(o.id, {
                                            is_form: !1
                                        }))
                                    }
                    ...
                    })), e.runtime.interval_gallery = e.runInterval(H, 1e3), _.forEach((function(t) {
                        var i = e.runtime.eventData[t];
                        if ("carousel" == i.type) {
                            var a = document.getElementById(t);
                            if (!isEmptyLadiPage(a)) {
                                ...
                                if (!isEmptyLadiPage(a) && "true" == a.getAttribute("data-scrolled") && "true" != a.getAttribute("data-stop")) {
                                    ...
                                    if (n && !isEmptyLadiPage(o) && (r = o), r > 0) {
                                        var d = a.getAttribute("data-next-time"),
                                            s = Date.now();
                                        isEmptyLadiPage(d) && (d = s + 1e3 * (r - 1), a.setAttribute("data-next-time", d)), s >= d && (U(t, !0), a.setAttribute("data-next-time", s + 1e3 * r))
                                    }
                                }
                            }
                        }))
                        ...
                        var t = 2500,
                            ...
                            a = function(a) {
                                ...
                                if (e.const.ANIMATED_LIST.forEach((function(t) {
                                    ...
                                    var o = a.getElementsByClassName("ladipage-animated-words-wrapper")[0];
                                    if (!isEmptyLadiPage(o)) {
                                        var r = isEmptyLadiPage(o.getAttribute("data-word")) ? [] : JSON.parse(o.getAttribute("data-word"));
                                        if (0 != r.length) {
                                            var d = !1,
                                                s = e.randomId(),
                                                l = function(i, a, n, o) {
                                                ...
                                                c = function(i, a, n, o) {
                                                    if (!d) {
                                                        var r = a.parentElement,
                                                            s = r.parentElement;
                                                        s.classList.contains("ladipage-animated-headline") || (s = s.parentElement), isEmptyLadiPage(i) || (i.classList.add("in"), i.classList.remove("out"));
                                                        var l = isEmptyLadiPage(i) ? null : i.nextSibling;
                                                        isEmptyLadiPage(l) ? ((s.classList.contains("rotate-2") || s.classList.contains("rotate-3") || s.classList.contains("scale")) && r.style.setProperty("width", a.clientWidth + "px"), isEmptyLadiPage(e.findAncestor(a, "type")) || e.runTimeout((function() {
                                                ...
                                                p = function(t, e) {
                                                    d || (t.classList.remove("is-visible"), t.classList.add("is-hidden"), e.classList.remove("is-hidden"), e.classList.add("is-visible"))
                                                },
                                                m = function(t, i) {
                                                    d || (isEmptyLadiPage(e.findAncestor(t, "type")) ? isEmptyLadiPage(e.findAncestor(t, "clip")) || (e.findAncestor(t, "ladipage-animated-words-wrapper").style.setProperty("width", t.clientWidth + 5 + "px"), e.runTimeout((function() {
                                                        g(t)
                                                    }), 2100)) : (c(t.querySelectorAll("i")[0], t, !1, i), t.classList.add("is-visible"), t.classList.remove("is-hidden")))
                                                },
                                                g = function(i) {
                                                    if (!d && !isEmptyLadiPage(i)) {
                                                        var a = u(i);
                                                        if (isEmptyLadiPage(e.findAncestor(i, "type")))
                                                            if (isEmptyLadiPage(e.findAncestor(i, "letters"))) isEmptyLadiPage(e.findAncestor(i, "clip")) ? isEmptyLadiPage(e.findAncestor(i, "loading-bar")) ? (p(i, a), e.runTimeout((function() {
                                                                g(a)
                                                            }), t)) : (e.findAncestor(i, "ladipage-animated-words-wrapper").classList.remove("is-loading"), p(i, a), e.runTimeout((function() {
                                                                g(a)
                                                            }), 3800), e.runTimeout((function() {
                                                                e.findAncestor(i, "ladipage-animated-words-wrapper").classList.add("is-loading")
                                                            }), 800)) : (e.findAncestor(i, "ladipage-animated-words-wrapper").style.setProperty("width", "2px"), e.runTimeout((function() {
                                                                p(i, a), m(a)
                                                            }), 600));
                                                            else {
                                                                var n = i.querySelectorAll("i").length >= a.querySelectorAll("i").length;
                                                                l(i.querySelectorAll("i")[0], i, n, 50), c(a.querySelectorAll("i")[0], a, n, 50)
                                                            }
                                                        else {
                                                            var o = e.findAncestor(i, "ladipage-animated-words-wrapper");
                                                            o.classList.add("selected"), o.classList.remove("waiting"), e.runTimeout((function() {
                                                                o.classList.remove("selected"), i.classList.remove("is-visible"), i.classList.add("is-hidden");
                                                                for (var t = i.querySelectorAll("i"), e = 0; e < t.length; e++) t[e].classList.remove("in"), t[e].classList.add("out")
                                                            }), 500), e.runTimeout((function() {
                                                                m(a, 150)
                                                            }), 1300)
                                                        }
                                                    }
                                                },
                                                _ = document.createElement(a.tagName);
                                            a.parentElement.insertBefore(_, a.nextSibling), _.outerHTML = a.outerHTML, (_ = a.nextSibling).classList.add("ladipage-animated-headline-duplicate"), e.runtime.list_scrolling_exec[s] = function() {
                                                a.parentElement.removeChild(a), _.classList.remove("ladipage-animated-headline-duplicate"), d = !0, delete e.runtime.list_scrolling_exec[s]
                                            };
                                            var y = o.textContent.trim();
                                            if (o.textContent = "", o.innerHTML = o.innerHTML + '<b class="is-visible">' + y + "</b>", r.forEach((function(t) {
                                                    isEmptyLadiPage(t) ? o.innerHTML = o.innerHTML + "<b>" + y + "</b>" : o.innerHTML = o.innerHTML + "<b>" + t.trim() + "</b>"
                                                })), !isEmptyLadiPage(e.findAncestor(o, "type")) || !isEmptyLadiPage(e.findAncestor(o, "loading-bar")) || !isEmptyLadiPage(e.findAncestor(o, "clip"))) {
                                                o.innerHTML = o.innerHTML + '<div class="after"></div>';
                                                for (var f = getComputedStyle(o).color, v = o.getElementsByClassName("after"), P = 0; P < v.length; P++) v[P].style.setProperty("background-color", f)
                                            }
                                            if (a.classList.contains("type") && o.classList.add("waiting"), (a.classList.contains("type") || a.classList.contains("rotate-2") || a.classList.contains("rotate-3") || a.classList.contains("scale")) && a.classList.add("letters"), function(t) {
                                                    if (!d)
                                                        for (var i = 0; i < t.length; i++) {
                                                            ...
                                                            for (var r in n) {
                                                                ...
                                                                isEmptyLadiPage(s) || (n[r] = "<em>" + n[r] + "</em>"), n[r] = o ? '<i class="in">' + n[r] + "</i>" : "<i>" + n[r] + "</i>"
                                                            }
                                                            var l = n.join("");
                                                            a.innerHTML = l, a.style.setProperty("opacity", 1)
                                                        }
                                                }(document.querySelectorAll(".letters b")), a.classList.contains("loading-bar")) i = 3800, e.runTimeout((function() {
                                                o.classList.add("is-loading")
                                            }), 800);
                                            else if (a.classList.contains("clip")) {
                                                var h = o.clientWidth + 5;
                                                o.style.setProperty("width", h + "px")
                                            }
                                            e.runTimeout((function() {
                                                g(a.getElementsByClassName("is-visible")[0])
                                            }), i)
                                        }
                                    }
                                }
                    ...
                    function() {
                        ...
                        if (0 != t.length) {
                            ...
                            if (!isEmptyLadiPage(i)) {
                                ...
                                if (isEmptyLadiPage(r)) {
                                    var d = i;
                                    isEmptyLadiPage(a) || (d += "_" + a), e.loadScript(e.const.LADISALES_SDK, {
                                        id: d,
                                        "data-time": e.runtime.timenow
                                    }, !0)
                                }
                            ...
                            n.forEach((function(t) {
                                ...
                                if (-1 != t || a || e.runTimeout(i, 3e3), 200 == t) {
                                    var o = JSON.parse(n),
                                        ...
                                        s = null,
                                        l = !1;
                                    isObjectLadiPage(o.data) ? (r = 1 == o.data.verified_domain, d = o.data.google_captcha, s = o.data.places_autocomplete, l = o.data.is_expires) : r = 1 == o.data, a || r || e.runTimeout(i, 3e3), isObjectLadiPage(d) && function(t, i, a) {
                                        if (!isEmptyLadiPage(t)) {
                                            var n = !1;
                                    ...
                                    }(d.site_key, d.enterprise, d), isObjectLadiPage(s) && (c = s.api_key, isEmptyLadiPage(c) || (window.onloadGooglePlacesAutocompleteCallback = function() {
                                    ...
                                    }, e.loadScript("https://maps.googleapis.com/maps/api/js?key=" + c + "&libraries=places&callback=onloadGooglePlacesAutocompleteCallback"))), l && function() {
                                        if (!isEmptyLadiPage(window.ladi("LADI_CLIENT_ID").get_cookie())) {
                                            var t = e.const.LANG.EXPIRES_TITLE,
                                                i = e.const.LANG.EXPIRES_DESC;
        ...
        }, e.runtime.tmp.runButtonSectionClose = R, e.runtime.tmp.runOptionAction = x, e.runtime.tmp.runOptionHover = D, e.runtime.tmp.runElementClickSelected = W, e.runtime.tmp.runTrackingAnalytics = C, e.runtime.tmp.runLadiSaleProductKey = tt, e.runtime.tmp.eventClickGalleryControlItem = j, e.runtime.tmp.runGallery = V, e.runtime.tmp.setGalleryStart = G, e.runtime.tmp.updateImageGalleryProduct = Q, e.runtime.tmp.runOptionCountdown = F, e.runtime.tmp.runOptionCountdownItem = q, e.runtime.tmp.getOptionLabelValue = z, e.runtime.tmp.updateLabelValue = K, e.runtime.tmp.getLabelValue = J, e.runtime.tmp.clickLabelProductChangeCallback = $, e.runtime.tmp.fireEventLabelChange = function(t) {
            var i = t.querySelector(".ladi-form-label-item.selected");
            isEmptyLadiPage(i) || e.fireEvent(i, "click", {
                is_fire_event: !0
            })
        }, e.runtime.tmp.showPopupX = ot, e.runtime.tmp.runActionPopupX = et, e.runtime.is_popupx ? (e.runtime.tmp.popupx_iframe_id = e.randomId(), et({
            ladipage_id: e.runtime.ladipage_id,
            action: {
                ...
                i.iframe_id == e.runtime.tmp.popupx_iframe_id && i.action.value.forEach((function(t) {
                    ! function(t, i) {
                        ...
                        if ("callback_request_with_option" == t && isFunctionLadiPage(e.runtime.tmp["request_callback_id_" + i.callback_id]) && e.runtime.tmp["request_callback_id_" + i.callback_id](i.responseText, i.status, i.httpRequest, i.url), "set_style_device" == t) {
                            if (dt(i.is_desktop), n = document.getElementById(e.runtime.tmp.popupx_current_element_id), isEmptyLadiPage(n)) return;
                            "none" != getComputedStyle(n).display && (e.runtime.tmp.popupx_is_inline ? rt(e.runtime.tmp.popupx_current_element_id, !1) : ot(e.runtime.tmp.popupx_current_element_id, !1))
                        }
                        if ("set_iframe_info" == t) {
                            ...
                            e.runtime.tmp.popupx_is_inline && (o += ".ladi-section > .ladi-section-close {display: none !important;}"), e.createStyleElement("style_popup_container", o), e.runtime.has_popupx = !0, st()
                        }
                        "hide_popupx" == t && (a = e.runtime.eventData[i], n = document.getElementById(i), isEmptyLadiPage(a) || isEmptyLadiPage(n) || window.ladi(i).hide()), "show_popupx" == t && ot(i, !0), "show_popupx_inline_iframe" == t && rt(i, !0), "show_message_callback" == t && (isFunctionLadiPage(e.runtime.tmp.popupx_show_message_callback) && e.runtime.tmp.popupx_show_message_callback(), delete e.runtime.tmp.popupx_show_message_callback)
                    }(i.action.type, t)
                }))
            } catch (t) {}
        }))) : st(), e.runtime.isRun = !0
    ...
    if (isArrayLadiPage(l) && l.length > 0) {
                ...
                return o.runLimitRequest(20, (function() {
                    if (o.runtime.isClient) {
                        ...
                        d == o.const.FORM_CONFIG_TYPE.ladisales ? ((A = {
                            "Content-Type": "application/json"
                        })["Store-Id"] = s, b = JSON.stringify(b)) : d == o.const.FORM_CONFIG_TYPE.wordpress ? (w = "GET", a = window.location.origin + "/ladipage/api?action=product_list&category_ids=" + l.join("|") + "&page=" + i + "&limit=" + e, b = null) : (A = {
                            "Content-Type": "application/json"
                        }, a = o.const.API_COLLECTION_PRODUCT, b = {
                            form_account_id: r,
                            tags: l,
                            limit: e
                        }, isEmptyLadiPage(h) ? b.page = i : b.page_info = h, b = JSON.stringify(b)), o.sendRequest(w, a, b, !0, A, (function(t, e, i) {
        ...
        if (isArrayLadiPage(P)) {
            ...
            }, isEmptyLadiPage(o.runtime.tmp.product_info[d]) && (o.runtime.tmp.product_info[d] = {}), P.forEach((function(t) {
    ...
    if (isEmptyLadiPage(e.runtime.shopping_product_type) || window.ladi("_shopping_product_type").get_cookie() != e.runtime.shopping_product_type && (window.ladi("_cart_token").delete_cookie(), window.ladi("_checkout_token").delete_cookie(), window.ladi("_shopping_product_type").set_cookie(e.runtime.shopping_product_type, 30)), -1 == [e.const.FORM_CONFIG_TYPE.sapo, e.const.FORM_CONFIG_TYPE.haravan, e.const.FORM_CONFIG_TYPE.wordpress].indexOf(e.runtime.shopping_product_type))
        if (-1 == [e.const.FORM_CONFIG_TYPE.shopify].indexOf(e.runtime.shopping_product_type)) {
            ...
            if (!isEmptyLadiPage(a)) return n["cart-token"] = a, void this.sendRequest("POST", this.const.API_LADISALE_SHOW, JSON.stringify({
                type: "LP"
            }), !0, n, (function(t, a, n) {
                if (n.readyState == XMLHttpRequest.DONE) {
                    if (200 == a) try {
    ...
    var r = function(t) {
        ...
        d = this.runtime.tmp.cart.findIndex(r); - 1 != d && (n.showLoadingBlur(), n.updateCartCookie({
    ...
    if (isObjectLadiPage(d)) {
        ...
        if (isArrayLadiPage(d.product.variants) && 0 != d.product.variants.length) {
            ...
            for (T = document.querySelectorAll(".ladi-form .ladi-form-label-container"), S = 0; S < T.length; S++) {
                ...
                isEmptyLadiPage(V) || o.findAncestor(T[S], "ladi-element").getAttribute("data-title-type") == o.const.PRODUCT_VARIANT_TITLE.top && (V = ": " + V);
    ...
    if (isObjectLadiPage(n) && isObjectLadiPage(n.product)) {
        ...
        if (isArrayLadiPage(n.product.variants) && 0 != n.product.variants.length) {
            ...
            if (isEmptyLadiPage(t["option.product_variant_id"]) || (s = n.product.variants.find((function(e) {
                ...
                }))), isEmptyLadiPage(s) && (s = n.product.variants[0]), e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.combined)
    ...
    var r = "";
    return r += "<tbody>", 0 == n.length ? r += '<tr><td class="ladi-cart-no-product">' + e + "</td></tr>" : n.forEach((function(e, n) {
        if (!(e.quantity <= 0)) {
            var o = {
                product_variant_id: e.product_variant_id,
    ...
    return isObjectLadiPage(d) && isObjectLadiPage(d.store_info) && isObjectLadiPage(d.product) && isArrayLadiPage(d.product.variants) && !(d.product.variants.length <= 0) ? (this.runtime.isClient ? Object.keys(this.runtime.eventData).forEach((function(e) {
            ...
            if (isObjectLadiPage(t)) {
                ...
                i == c.const.PRODUCT_VARIANT_TYPE.combined && (d += '<div class="ladi-form-item-container"><div class="ladi-form-item-background"></div><div class="ladi-form-item"><select' + (isObjectLadiPage(t.store_info) && !isNullLadiPage(t.store_info.id) ? ' data-store-id="' + t.store_info.id + '"' : "") + ' data-product-id="' + t.product.product_id + '" required tabindex="' + o + '" class="ladi-form-control ladi-form-control-select" data-selected=""' + (r ? "" : ' onmousedown="javascript: event.preventDefault();"') + ">", c.runtime.isClient && (d += '<option value="" data-product-variant-id="">' + c.const.LANG.OPTION_NO_SELECT + "</option>"), isArrayLadiPage(t.product.variants) && t.product.variants.forEach((function(e, i) {
                    ...
                    if (e.is_tmp) d += '<div class="ladi-form-item-box"></div>';
                        ...
                        var n = null;
                        isEmptyLadiPage(i) || isStringLadiPage(i.option_ids) && (n = i.option_ids.split("/")), e.values.forEach((function(t) {
                            var a = function(t) {
                                var a = "";
                    ...
                    if (isArrayLadiPage(e.values) && 0 != e.values.length) {
                        ...
                        isArrayLadiPage(t.product.variants) && (i = t.product.variants[0]);
                        var n = null;
                        isEmptyLadiPage(i) || isStringLadiPage(i.option_ids) && (n = i.option_ids.split("/")), e.values.forEach((function(t, a) {
                    ...
                    b = function(t) {
                        if (h = isObjectLadiPage(c.runtime.tmp.product_info[m][_]) ? c.runtime.tmp.product_info[m][_] : t.data, isObjectLadiPage(h)) {
                            if (!isObjectLadiPage(h.store_info)) {
                                ...
                                c.runtime.isClient || (e = window.$rootScope.getStoreCurrency()), h.store_info = {
                                    currency: {
                                        code: e,
                ...
                return c.runLimitRequest(20, (function() {
                    if (c.runtime.isClient) {
                        ...
                        m == c.const.FORM_CONFIG_TYPE.ladisales ? ((w = {
                            "Content-Type": "application/json"
                        })["Store-Id"] = g, A = JSON.stringify(A)) : m == c.const.FORM_CONFIG_TYPE.wordpress ? (T = "GET", t = window.location.origin + "/ladipage/api?action=product_info&product_id=" + _, A = null) : (w = {
                            "Content-Type": "application/json"
                        }, t = c.const.API_SHOW_PRODUCT, A = {
                            form_account_id: p,
                            product_id: _
                        }, A = JSON.stringify(A)), c.sendRequest(T, t, A, !0, w, (function(t, e, i) {
                            if (i.readyState == XMLHttpRequest.DONE) try {
                                var a = JSON.parse(t);
                                b(a)
                            } catch (t) {
                            ...
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    for (var r = 0, d = [], c = e.createTmpElement("div", t, null, !1).querySelectorAll('[for^="shippingMethod-"]'), u = 0; u < c.length; u++) {
                                        ...
                                        isEmptyLadiPage(y) || (y = y.querySelector('input[name="shippingMethod"]'), isEmptyLadiPage(y) || (g = y.value)), isEmptyLadiPage(p) || isEmptyLadiPage(g) || d.push({
                                            name: p,
                                            fee: m,
                            ...
                            if (o.readyState == XMLHttpRequest.DONE) {
                                if (200 == n) try {
                                    for (var r = 0, d = [], c = e.createTmpElement("div", t, null, !1).querySelectorAll('[for^="shipping_rate_id_"]'), u = 0; u < c.length; u++) {
                                        ...
                                        isEmptyLadiPage(y) || (g = y.value), isEmptyLadiPage(p) || isEmptyLadiPage(g) || d.push({
                                            name: p,
                                            fee: m,
                                            shipping_method_id: g
                                        })
                    ...
                    g = {
                        ...
                        if (n.readyState == XMLHttpRequest.DONE) {
                            if (200 == i) try {
                                ...
                                if (200 == o.code) {
                                    var r = 0;
                                    return isArrayLadiPage(o.data.shipping_methods) && (-1 == o.data.shipping_methods.findIndex((function(t) {
                                        return t.shipping_method_id == e.runtime.tmp.add_to_cart_shipping_method_id
    ...
    t.getCheckoutSapo(null, (function(e, i) {
        ...
        if (!isEmptyLadiPage(n)) {
            ...
            if (!isEmptyLadiPage(r)) {
                ...
                isEmptyLadiPage(d) || (d.value = n.textContent.trim(), t.fireEvent(d, "change"), t.runtime.tmp.current_use_coupon = d.value, t.reloadPriceDiscount({
                    target: r,
                    discount_price: a
                }))
            }
        ...
        if (!isEmptyLadiPage(n)) {
            ...
            if (!isEmptyLadiPage(o)) {
                ...
                if (!isEmptyLadiPage(d)) {
                    ...
                    isEmptyLadiPage(s) || (s.value = o.getAttribute("data-coupon"), t.fireEvent(s, "change"), t.runtime.tmp.current_use_coupon = s.value, t.reloadPriceDiscount({
                        target: d,
                        discount_price: a,
                        docCrawl: e
                    }))
        ...
        a = function(n, o) {
            ...
            if ((i != e.runtime.tmp.current_use_coupon || isEmptyLadiPage(t) || !t.isRemoveCoupon || !isEmptyLadiPage(t.docCrawl)) && e.runtime.shopping_product_type == e.const.FORM_CONFIG_TYPE.haravan) {
                if (delete e.runtime.tmp.use_cart_line_price_original, !isEmptyLadiPage(e.runtime.tmp.current_use_coupon)) {
                    ...
                    isEmptyLadiPage(l) || (l = (parseFloatLadiPage(l.getAttribute("data-checkout-subtotal-price-target")) || 0) / 100, e.changeTotalPriceCart(!0).cart_price != l && (e.runtime.tmp.use_cart_line_price_original = !0))
                }
                e.updateCartPromotion()
            }
        };
        ...
        if (0 != e.runtime.tmp.list_form_checkout.length) {
            ...
            if (isEmptyLadiPage(t) ? i = document.getElementById(e.runtime.tmp.list_form_checkout[0]) : (i = e.findAncestor(t.target, "ladi-form"), isEmptyLadiPage(i) || (i = i.querySelector("[data-submit-form-id]"), isEmptyLadiPage(i) || (i = document.getElementById(i.getAttribute("data-submit-form-id"))))), isEmptyLadiPage(i)) a(0);
                ...
                if (isEmptyLadiPage(d)) a(0);
                    ...
                    n = {
                        discount_code: l
                    }, isEmptyLadiPage(o) || (n.email = o.value), isEmptyLadiPage(r) || (n.phone = r.value), e.runtime.tmp.is_click_check_price_discount = !0;
                    var c = null,
                        u = null,
                        p = null;
    ...
    if (isObjectLadiPage(a.runtime.tmp.info_update_cart_promotion) || (a.runtime.tmp.info_update_cart_promotion = {}), !isEmptyLadiPage(t)) {
        ...
        return a.runtime.tmp.cart = [], -1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && t.items.forEach((function(e) {
            var i = null; - 1 != [a.const.FORM_CONFIG_TYPE.sapo].indexOf(a.runtime.shopping_product_type) && e.name == e.title && "Default Title" == e.variant_title && (e.variant_title = null), -1 != [a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) && e.product_title == e.title && "Default Title" == e.variant_title && (e.variant_title = null), -1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type) && (i = {
                store_id: -1,
                product_id: e.product_id,
            ...
            a.runtime.isClient || (n = window.$rootScope.getStoreCurrency()), -1 == [a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type) || isEmptyLadiPage(t.currency) || (n = t.currency), i.currency = {
                code: n,
            ...
            if (-1 != [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type)) {
                if (i.price = e.price_original, isObjectLadiPage(e.properties)) {
                    ...
                    c.length > 0 && (r = e.properties[c[0]], -1 != [a.const.FORM_CONFIG_TYPE.haravan].indexOf(a.runtime.shopping_product_type) && ((r = r.split("-")).shift(), r = (r = r.join("-")).trim()), d = {
                        product_id: e.product_id,
                        product_variant_id: e.variant_id,
            ...
            var i = {
                ...
                n = t.currency;
            isEmptyLadiPage(n) && (n = a.runtime.currency), a.runtime.isClient || (n = window.$rootScope.getStoreCurrency()), i.currency = {
                code: n,
                symbol: a.formatCurrency(null, n, !1, !0)
            };
            var o = l.findIndex((function(t) {
        ...
        if (a.runtime.tmp.info_update_cart_promotion[d] = !0, -1 == [a.const.FORM_CONFIG_TYPE.sapo, a.const.FORM_CONFIG_TYPE.haravan, a.const.FORM_CONFIG_TYPE.shopify].indexOf(a.runtime.shopping_product_type))
            if (-1 == [a.const.FORM_CONFIG_TYPE.wordpress].indexOf(a.runtime.shopping_product_type)) {
                ...
                if (o.readyState == XMLHttpRequest.DONE) {
                    if (200 == n) try {
                        var r = JSON.parse(t);
                        return delete a.runtime.tmp.info_update_cart_promotion[d], a.updateCartPromotion(r), e && a.runtime.tmp.cart.length > 0 && a.reloadCheckoutWordpress(), a.changeTotalPriceCart(), void(isFunctionLadiPage(i) && i())
                    } catch (t) {}
                    delete a.runtime.tmp.info_update_cart_promotion[d], isFunctionLadiPage(i) && i()
                }
            }));
    ...
    var o = this,
        ...
        d = null,
        s = null;
    if (-1 != [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type)) return -1 != [o.const.FORM_CONFIG_TYPE.sapo].indexOf(o.runtime.shopping_product_type) && (d = {
    ...
    }), []).join("&")), -1 != [o.const.FORM_CONFIG_TYPE.haravan].indexOf(o.runtime.shopping_product_type) && (d = {
        "Content-Type": "application/x-www-form-urlencoded",
        "X-Requested-With": "XMLHttpRequest"
    }, s = {
        ...
        return t.push(e + "=" + encodeURIComponent(s[e])), t
    }), []).join("&")), -1 != [o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type) && (d = {
        "Content-Type": "application/x-www-form-urlencoded",
        "X-Requested-With": "XMLHttpRequest"
    }, s = {
        id: e.product_variant_id,
    ...
    if (-1 == [o.const.FORM_CONFIG_TYPE.wordpress].indexOf(o.runtime.shopping_product_type)) {
        ...
        (d = {
            "Content-Type": "application/json"
        })["store-id"] = t, isEmptyLadiPage(l) || (d["cart-token"] = l);
        var c = e.quantity;
        s = JSON.stringify({
            type: "LP",
            product_variant_id: e.product_variant_id,
    ...
    if (-1 == [o.const.FORM_CONFIG_TYPE.sapo, o.const.FORM_CONFIG_TYPE.haravan, o.const.FORM_CONFIG_TYPE.shopify].indexOf(o.runtime.shopping_product_type)) {
        ...
        if (-1 != [o.const.FORM_CONFIG_TYPE.sapo].indexOf(o.runtime.shopping_product_type) && (l = window.location.origin + "/cart/change.js", s = {
                "Content-Type": "application/x-www-form-urlencoded",
                "X-Requested-With": "XMLHttpRequest"
            }, d = {
            ...
            }), []).join("&")), -1 != [o.const.FORM_CONFIG_TYPE.haravan].indexOf(o.runtime.shopping_product_type) && (l = window.location.origin + "/cart/update.js", s = {
                "Content-Type": "application/x-www-form-urlencoded",
                "X-Requested-With": "XMLHttpRequest"
            ...
            l = window.location.origin + "/cart/change.js", s = {
                "Content-Type": "application/json",
                "X-Requested-With": "XMLHttpRequest"
            };
                    ...
                    var v = function() {
                        ...
                        t.forEach((function(t) {
                            t.action_type == o.const.ACTION_TYPE.action && (t.type == o.const.DATA_ACTION_TYPE.popup_cart && (window.ladi("POPUP_CART").show(), o.runEventTracking(e.id, {
                                is_form: !1
                            })), t.type == o.const.DATA_ACTION_TYPE.popup_checkout && (o.runtime.shopping_third_party ? o.getThirdPartyCheckoutUrl(!0) : window.ladi("POPUP_CHECKOUT").show(), o.runEventTracking(e.id, {
                                is_form: !1
                            })))
                        }))
                    };
                ...
                if (isObjectLadiPage(u) && isArrayLadiPage(u.products)) {
                    ...
                    for (v.setAttribute("data-max-option-length", S), O = 0; O < u.products.length; O++)
                        if (!(F.length > O)) {
                            ...
                            for (var M = B.getElementsByClassName("ladi-element"); isArrayLadiPage(u.products[O].options) && u.products[O].options.length < S;) u.products[O].options.push({
                                is_tmp: !0
                            });
...
var lightbox_run = function(t, e, i, a, n, o, r, d) {
    ...
    lightbox_image = function(t) {
        isEmptyLadiPage(t) || lightbox_run('<img class="lightbox-item" style="margin: auto; position: absolute; top: 0; left: 0; bottom: 0; right: 0; object-fit: scale-down; max-width: 80%; max-height: 80%;" />', t, !1, !1, "lightbox_image")
    },
...
LadiPageLibraryV2.prototype.get_url = function(t, e, i) {
    if (!isEmptyLadiPage(this.id)) {
        ...
        return a = LadiPageScript.getLinkUTMRedirect(a, null), LadiPageScript.convertDataReplaceStr(a, !0, null, !1, t)
    }
        ...
        if (LadiPageScript.runtime.has_popupx) this.show();
            ...
            for (var a = document.querySelectorAll("#" + LadiPageScript.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), n = 0; n < a.length; n++)
                if (a[n].id != this.id && a[n].hasAttribute("data-popup-backdrop") && "none" != getComputedStyle(a[n]).display) {
                    ...
                    isEmptyLadiPage(o) || (o = LadiPageScript.findAncestor(o, "ladi-element")), (isEmptyLadiPage(o) || o.id != a[n].id) && LadiPageScript.runRemovePopup(a[n].id, !0)
                }
            var r = isObjectLadiPage(LadiPageScript.runtime.story_page),
                d = function(t, e, i) {
                    ...
                    var a, n = function(t, e, i, a) {
                        return (t /= a / 2) < 1 ? i / 2 * t * t + e : -i / 2 * (--t * (t - 2) - 1) + e
                    };
                    a = r ? "left" == t ? e.scrollLeft : e.scrollTop : "left" == t ? e.scrollX : e.scrollY;
                    ...
                    if (0 != d) {
                        ...
                        if (p) {
                            var y = Date.now() + c;
                            p(m = function() {
                                l = c - (y - Date.now()), g = n(l, a, d, c), _(g), l < c ? p(m) : _(i)
                            })
                        } else(m = function() {
                            g = n(l += 20, a, d, c), _(g), l < c ? LadiPageScript.runtime.tmp.scroll_timeout_id = LadiPageScript.runTimeout(m, 20) : _(i)
                        })()
                    }
                },
                s = function(t) {
                ...
                c = null,
                u = null;
            e ? r ? i.scrollIntoView() : (l = s(window), window.scrollTo({
                top: l.scrollTop
            })) : LadiPageScript.runTimeout((function() {
                var t;
                ...
                }, d("left", u, c.scrollLeft)), LadiPageScript.runtime.story_page.type == LadiPageScript.const.STORY_PAGE.vertical && (l = s(u), d("top", u, l.scrollTop))) : (u = window, l = s(u), LadiPageScript.runtime.isDesktop || LadiPageScript.runtime.isBrowserDesktop ? window.scrollTo({
                    top: l.scrollTop,
                    behavior: "smooth"
                }) : d("top", u, l.scrollTop))
            }), 100)
        ...
        if (4 == s.length)
            ...
            for (r = 0; r < p.length; r++)
                if (isNullLadiPage(t)) {
                    ...
                    (h = h || "").startsWith('url("') && (h = h.substring(5)), h.endsWith('")') && (h = h.substring(0, h.length - 2)), n.push(h)
            ...
            for (r = 0; r < g.length; r++) {
                ...
                if (isNullLadiPage(t)) isEmptyLadiPage(b) || n.push({
    ...
    if (!isEmptyLadiPage(i)) {
        var a = !1;
        0 == i.getElementsByClassName("ladi-popup").length ? (LadiPageScript.runtime.has_popupx && i.classList.contains("ladi-section") && "none" != getComputedStyle(i).display && (a = !0), i.style.setProperty("display", "none", "important"), LadiPageScript.reloadLazyload(!1), !t && a && LadiPageScript.runtime.tmp.runActionPopupX({
            id: this.id,
            dimension: {
                display: "none"
            },
    ...
    if (!isEmptyLadiPage(t) && "true" == t.getAttribute("data-dropbox")) {
        ...
        t.removeAttribute("data-dropbox-backdrop"), 0 == (o = document.querySelectorAll('[data-dropbox-backdrop="true"]')).length && document.getElementById(LadiPageScript.runtime.backdrop_dropbox_id).style.removeProperty("display"), document.querySelector("#" + LadiPageScript.runtime.builder_section_popup_id + " > .ladi-container").appendChild(t)
    }
    ...
    if (!isEmptyLadiPage(a)) {
        ...
        if (!isEmptyLadiPage(m)) {
            var v = function(t) {
                t = isEmptyLadiPage(t) ? "" : "." + t;
                var e = "";
                return e += "#" + a.id + t + ", ", e += "#" + a.id + t + " .ladi-headline, ", (e += "#" + a.id + t + " .ladi-paragraph, ") + "#" + a.id + t + " .ladi-list-paragraph"
            };
...
var LadiPageAppV2, ladi = ladi || function(t, e) {
    ...
    ladi_fbq = function(t, e, i, a) {
        isObjectLadiPage(window.ladi_conversion_api) && isObjectLadiPage(window.ladi_conversion_api.facebook) && isArrayLadiPage(window.ladi_conversion_api.facebook.pixels) && (isObjectLadiPage(a) || (a = {}), a.eventID = "ladi." + Date.now() + "." + (Math.floor(9e10 * Math.random()) + 1e10)), LadiPageTrackingCommand.push((function() {
            return isFunctionLadiPage(window.fbq)
        }), (function() {
...
})), delete window.ladi_fbq_data), (LadiPageAppV2 = LadiPageAppV2 || function() {}).prototype.notify_runtime = function(t, e) {
    var i = function() {},
        a = "top_left",
        n = "top_center",
        o = "top_right",
                    ...
                    if ((l = a(e)) >= s) LadiPageScript.showMessage(LadiPageScript.const.LANG.GAME_MAX_TURN_MESSAGE.format(s));
                        ...
                        if (isEmptyLadiPage(m)) g = !1;
                            ...
                            var y = parseFloatLadiPage(p.getAttribute("data-rotate")) || 0,
                                ...
                                v = "rotate(" + f + "deg)";
                            p.setAttribute("data-rotate", f), p.style.setProperty("transform", v), p.style.setProperty("-webkit-transform", v), "NEXT_TURN" != m.value.toUpperCase() && (l++, window.ladi("_total_turn_" + e).set_cookie(l, 1)), LadiPageScript.runTimeout((function() {
