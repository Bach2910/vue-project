  ...
  <div>
    <div class="people-header-title container">
      <div class="headerBlog-container">
        <div class="link">
          <span class="nav-link"><a href="#">Trang chủ</a>> Tài liệu
 </span>
        </div>
        <div class="dropdown">
      ...
      <div class="td-category-title">
        <h1 class="td-page-title">Tài liệu
        </h1>
        ...
        <div class="td-pb-row">
          <div class="td-pb-span8 td-main-content">
            <div class="td-ss-main-content">
              <div v-for="(document, index) in paginatedArticles" :key="index"
                   class="td_module_11 mt-5 td_module_wrap td-animation-stack">
                <div class="td-module-thumb mb-2">
                  <a :href="document.url" rel="bookmark" class="td-image-wrap" :title="document.title">
                    <img class="entry-thumb animation" :src="document.image_url" :alt="document.title" width="324"
                         height="235"/>
                  </a>
                </div>
...
const performSearch = () => {
  if (searchQuery.value) {
    ...
    const filteredArticles = documents.value.filter(document =>
...
const documentsPerPage = 3; // Số bài viết hiển thị trên mỗi trang
