  ...
  <div>
    <div class="people-header-title container">
      <div class="headerBlog-container">
        <div class="link">
          <span class="nav-link"><a href="#">Trang chủ</a>> Mẫu đề Test Online
 </span>
        </div>
        <div class="dropdown">
      ...
      <div class="td-category-title">
        <h1 class="td-page-title">Mẫu đề Test Online
        </h1>
        <div class="description">
          <p>Testcenter cung cấp hệ thống và mẫu đề <b>test online</b> giúp doanh nghiệp và ứng viên đánh giá tính cách, tư duy, khả năng tính toán thông qua bài test IQ, EQ, MBTI, DISC và đề thi TOEIC,…  </p>
        </div>
      </div>
    </div>
        ...
        <div class="td-pb-row">
          <div class="td-pb-span8 td-main-content">
            <div class="td-ss-main-content">
              <div v-for="(exam, index) in paginatedArticles" :key="index"
                ...
                <div class="td-module-thumb mb-2">
                  <a :href="exam.url" rel="bookmark" class="td-image-wrap" :title="exam.title">
                    <img class="entry-thumb animation" :src="exam.image_url" :alt="exam.title" width="324"
                         height="235"/>
                  </a>
                </div>
                <div class="item-details">
                  ...
                  <div class="module-meta-info mb-2">
                    <router-link to="/blog/tai-lieu" class="td-post-category">Tài liệu</router-link>
                  </div>
                  <div class="excerpt mb-3">
                    {{ exam.excerpt }}
                  </div>
                  <div class="read-more">
                    <router-link to="/blog/tuyen-mass" class="td-post-category" >Xem thêm</router-link>
                  </div>
                </div>
              </div>
...
const performSearch = () => {
  if (searchQuery.value) {
    ...
    const filteredArticles = exams.value.filter(exam =>
...
const examsPerPage = 3; // Số bài viết hiển thị trên mỗi trang
const totalPages = computed(() => Math.ceil(exams.value.length / examsPerPage));

// Lọc bài viết theo trang hiện tại
