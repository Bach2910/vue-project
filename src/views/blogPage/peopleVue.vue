  ...
  <div>
    <div class="people-header-title container">
      <div class="headerBlog-container">
        <div class="link">
          <span class="nav-link"><a href="#">Trang chủ</a>> Nhân sự</span>
        </div>
        <div class="dropdown">
      ...
      <div class="td-category-title">
        ...
        <div class="description">
          <p>Nắm bắt tâm lý nhân viên, thấu hiểu thị trường lao động và cập nhật những xu hướng quản trị nhân sự mới sẽ
            mở ra cho doanh nghiệp “cánh cửa” chào đón nhân tài. </p>
        </div>
      </div>
    </div>
              ...
              <div v-for="(article, index) in paginatedArticles" :key="index"
                ...
                <div class="item-details">
                  ...
                  <div class="module-meta-info mb-2">
                    <router-link to= "/blog/nhan-su" class="td-post-category">Nhân sự</router-link>
                  </div>
                  <div class="excerpt mb-3">
                    {{ article.excerpt }}
                  </div>
                  <div class="read-more">
                    <router-link to="/blog/equity-theory-la-gi" class="td-post-category" >Xem thêm</router-link>
                  </div>
                </div>
              </div>
...
const articlesPerPage = 3; // Số bài viết hiển thị trên mỗi trang
