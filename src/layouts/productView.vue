...
const handleScroll = () => {
  const halfPageHeight = document.documentElement.scrollHeight / 9;
  isScrollToTopVisible.value =
    document.documentElement.scrollTop > halfPageHeight ||
    document.body.scrollTop > halfPageHeight;
};
const scrollToTop = () => {
  ...
  <div :class="{ 'zoomed': isZoomed }">
    <div class="td-header">
      <div class="tdc-row">
        ...
        <div class="header-mobi d-block d-md-none">
          <div class="mobi-telephone">
            <div class="telephone-hidden">
              <div class="hamburger" @click="openOverlay(); zoomIn()">
              ...
              <div v-if="isOverlayVisible" class="overlay">
                <div class="header-overlay">
                  ...
                  <span class="close-btn" @click="closeOverlay(); zoomOut()">
            ...
            <div class="logo-header-hidden">
              <img src="https://www.testcenter.vn/blog/wp-content/uploads/2020/11/logo-header-3-1.png"
                   alt="logo testcenter" width="auto" height="54">
            </div>
            <div class="search-hidden">
              <div class="search-button" @click="openOverlaySearch(); zoomIn()">
                <i class="fa-solid fa-magnifying-glass"></i>
              </div>
              <div v-if="isSearchOverlayVisible" class="overlay-search">
                <form class="tdc-title" @submit="performSearch">
                  <span>TÌM KIẾM</span><br>
                  <input v-model="searchQuery" class="input-search" type="text">
                </form>
                <span class="search-close-btn" @click="closeOverlaySearch(); zoomOut()">
                  <i class="fa-solid fa-x"></i>
                </span>
              </div>
            </div>
        ...
        <!-- Desktop Header -->
        <div class="pc d-md-block d-none">
    ...
    <div class="footer-resources container">
      ...
      <div class="about-us-footer">
        ...
        <br>
        <p>Nền tảng công nghệ tạo bài test và tổ chức kỳ thi online dành riêng cho doanh nghiệp Việt Nam trong
          đánh
          giá
      ...
      <div class="watch-us">
        ...
        <div class="button-footer">
          ...
          <a type="button" class="social-button"><i class="fa-brands fa-facebook td-icon-font"></i></a>
            </span>
          <span class="td-social-icon-wrap">
          <a type="button" class="social-button"><i class="fa-solid fa-circle-info td-icon-font"></i></a>
            </span>
          <span class="td-social-icon-wrap">
          <a type="button" class="social-button"><i class="fa-solid fa-envelope td-icon-font"></i></a>
            </span>
        </div>
      </div>
    </div>
    <button v-show="isScrollToTopVisible" id="scrollToTopBtn" @click="scrollToTop">
